...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1833940312').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001890997597')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001917840638')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", True))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kamat2001:kamat2001@cluster0.a1rl9pf.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Funda_Family')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Funda_Family2')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Funda_Family')
...
URL = "https://filtersbots.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filtersbots.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filtersbots.onrender.com/".format(FQDN)
else:
    URL = "https://filtersbots.onrender.com/".format(FQDN)
